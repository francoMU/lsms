...
// Read atom positions and evecs
  ...
  luaGetBoolean(L, "box_relax", &lsms.relaxParams.box_relax);
  luaGetBoolean(L, "x_relax", &lsms.relaxParams.x);
  luaGetBoolean(L, "y_relax", &lsms.relaxParams.y);
  luaGetBoolean(L, "z_relax", &lsms.relaxParams.z);
  luaGetBoolean(L, "iso_relax", &lsms.relaxParams.iso);
