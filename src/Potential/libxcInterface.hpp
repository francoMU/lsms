...
const int NUM_FUNCTIONAL_INDICES = 3;
...
public:
  ...
  xc_func_type functional[NUM_FUNCTIONAL_INDICES - 1];
  ...
  void evaluate(std::vector<Real> &rMesh, Matrix<Real> &rhoIn, int jmt, int nSpin, Matrix<Real> &xcEnergyOut,
