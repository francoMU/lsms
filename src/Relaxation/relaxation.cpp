...
lsms::Relaxation::Relaxation(lsms::BaseFunction<double> &base_function,
...
void lsms::Relaxation::start(const std::vector<double> &x_n_0,
...
void lsms::Relaxation::update_step(std::vector<double> &x_n_0,
                                   std::vector<double> &x_n_1) {
...
bool lsms::Relaxation::calculate_minimum(std::vector<double> &x_result, bool save_steps) {
...
bool lsms::Relaxation::check_convergence(const std::vector<double> &grad) {
...
void lsms::Relaxation::iteration(std::vector<double> &x_n_0,
                                 std::vector<double> &x_n_1,
                                 std::vector<double> &grad_n_0,
                                 std::vector<double> &grad_n_1) {
...
void lsms::Relaxation::printRelaxationHistory() const {
