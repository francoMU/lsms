...
void setupVorpol(LSMSSystemParameters &lsms,
    ...
    for (int i = 0; i < local.num_local; i++) {
        ...
        setup_vorpol_(&my_atom,
                      ...
                      &lsms.ngaussq,
                      &lsms.ngaussr,
                      &local.atom[i].voronoi.rInscribedSphere,
                      &local.atom[i].voronoi.omegaInt,
                      ...
                      &local.atom[i].voronoi.wylm(0, 0, 0),
...
void calculateVolumes(LSMSCommunication &comm, LSMSSystemParameters &lsms, CrystalParameters &crystal,
                      LocalTypeInfo &local) {
